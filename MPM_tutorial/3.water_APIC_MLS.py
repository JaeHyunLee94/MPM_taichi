...
particle_initial_volume = (grid_dx * 0.5) ** 2
particle_mass = particle_rho * particle_initial_volume
dt = 1e-4

# material property
bulk_modulus = 5  ## lame's second coefficient
gamma = 1  ## compressibility
E = 1000
...
def substep():
    ...
    for p in ti_particle_pos:
        ...
        for i, j, k in ti.static(ti.ndrange(3, 3, 3)):
            ...
            ti_grid_vel[base + offset] += weight * (particle_mass * ti_particle_vel[p] + dt * affine @ dpos)
...
def render_gui():
    ...
    E = window.GUI.slider_float("E", E, 10, 1000)
    window.GUI.end()
